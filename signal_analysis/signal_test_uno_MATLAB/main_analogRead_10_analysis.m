...
%%
rawdata=importdata('analogRead_10_data.csv');
...
title('Raw signal - analogRead_resolution 10');
...
fprintf('time consumption - analogRead_resolution 10_ mean : %f [us], std : %f [us]\n',mean(time_consume_digitalRead)*10^6,std(time_consume_digitalRead)*10^6);
